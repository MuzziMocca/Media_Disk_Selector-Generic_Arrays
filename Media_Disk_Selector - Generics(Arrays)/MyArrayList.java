/**This is a generic class that is a ble to create an array of objects and also 
 * contains methods to populate and manipulate the array to be used by MediaDiskObject class*/
